...
const EmployerDetailsPage = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full md:max-w-md mx-auto bg-white rounded-xl shadow-lg border border-gray-200 min-h-screen md:min-h-0 flex flex-col"
    >
      {/* Contenitore principale */}
      <div className="p-6 md:py-4 flex-grow flex flex-col">
        ...
        <div className="grid grid-cols-3 gap-4 text-center mb-8">
          {[
            ...
            >
              ...
              <div
                className={`relative flex items-center justify-center rounded-full w-24 h-24 mx-auto border-4 ${circle.borderColor} ${circle.color} shadow-lg`}
              >
      ...
      <div className="p-4 rounded-lg shadow-md bg-purple-200 flex justify-around">
